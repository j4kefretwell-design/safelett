...
export default function AppSidebar({ open, onClose }: AppSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-[min(100vw,18rem)] max-w-full flex-col transition-[background-color,transform] duration-[400ms] ease-[ease] ${sidebarBgClass(
          mode
